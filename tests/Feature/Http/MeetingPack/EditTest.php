...
class EditTest extends TestCase
{
    ...
    public function test_student_cannot_view_meeting_pack_edit(): void
    {
        ...
        // Act
        $response = $this->actingAs($student)->get(route('admin.meeting-packs.edit', $pack));
        // Assert
    ...
    public function test_coach_cannot_view_meeting_pack_edit(): void
    {
        ...
        $pack = MeetingPack::factory()->create();
        // Act
        $response = $this->actingAs($coach)->get(route('admin.meeting-packs.edit', $pack));
        // Assert
        $response->assertForbidden();
    }
    ...
    public function test_admin_can_view_meeting_pack_edit(): void
    {
        ...
        $pack = MeetingPack::factory()->create();
        // Act
        $response = $this->actingAs($admin)->get(route('admin.meeting-packs.edit', $pack));
        // Assert
        $response->assertOk();
    }
}
