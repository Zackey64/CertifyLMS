...
class MarkAllAsReadTest extends TestCase
{
    ...
    // 受講生は通知をすべて既読にできる
    public function test_student_can_mark_all_as_read(): void
    {
        // Arrange
        ...
        // Act
        $response = $this->actingAs($student)->post(route('notifications.markAllAsRead'));
        // Assert
    ...
    // コーチは通知をすべて既読にできる
    public function test_coach_can_mark_all_as_read(): void
    {
        // Arrange
        ...
        // Act
        $response = $this->actingAs($coach)->post(route('notifications.markAllAsRead'));
        // Assert
        $response->assertRedirect();
        $this->assertNotNull($databaseNotification->fresh()->read_at);
    }
    ...
    // 管理者は通知をすべて既読にできない
    public function test_admin_cannot_mark_all_as_read(): void
    {
        // Arrange
        ...
        // Act
        $response = $this->actingAs($admin)->post(route('notifications.markAllAsRead'));
        // Assert
